...
if [ -z "${1:-}" ]; then
    echo "Uso: $0 <nome_do_arquivo.txt>"
    exit 1
fi
...
RU_MATRIZ="${SCRIPT_DIR}/ru_matriz.yml"
CLUSTER_TIMEINTERVAL="${SCRIPT_DIR}/generated/cluster_timeinterval.csv"
...
echo "Matrizes YAML da GNB: ${SCRIPT_DIR}/GNB_<N>RU_matriz.yml"
echo "Diretório base de saída: ${SCRIPT_DIR}/generated"
...
while IFS= read -r linha || [ -n "$linha" ]; do
    ...
    CONFIG_DIR="${SCRIPT_DIR}/generated/gnb_${DU_ID}"
    ...
    GNB_MATRIZ="${SCRIPT_DIR}/GNB_${CONT}RU_matriz.yml"
    ...
    echo "============================================================"
    echo " Coletando dados por 5 Minutos  "
    echo "============================================================"
    ...
    echo "Fim: $DATA_FIM" 
	echo "$DU_ID;$DATA_INICIO;$DATA_FIM" >> $CLUSTER_TIMEINTERVAL
    echo "============================================================"
